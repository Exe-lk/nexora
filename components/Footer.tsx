...
export function Footer() {
  ...
  const shellOverlayBg = isDark
    ...
    : "linear-gradient(180deg, rgba(250,245,235,0.55) 0%, rgba(255,250,240,0.7) 45%, rgba(255,255,255,0.9) 100%)";

  const labelColor = isDark ? "rgba(148,163,184,0.85)" : "rgba(106,76,41,0.9)";
  const textSoft = isDark ? "rgba(148,163,184,0.7)" : "rgba(90,64,35,0.72)";
  const linkColor = isDark ? "rgba(226,232,240,0.85)" : "rgba(139,99,54,0.95)";
  const bulletGradient = isDark
    ? "linear-gradient(to right, rgba(148,163,184,0.2), rgba(148,163,184,0.7))"
    : "linear-gradient(to right, rgba(201,147,62,0.4), rgba(212,165,116,0.8))";
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-4 sm:px-6 pt-12 pb-0 md:pt-16">
        ...
        <div
          ...
          style={{
            borderColor: isDark ? "rgba(148,163,184,0.2)" : "rgba(201,147,62,0.2)",
          }}
        >
          <span
            style={{
